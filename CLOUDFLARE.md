...
- D1 stores accounts, password hashes, surveys, history, feedback, and hashed login sessions.
...
- Database fields or tables: create a new migration rather than changing `0001_persistent_accounts.sql`:
